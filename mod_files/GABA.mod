...
NEURON {
  POINT_PROCESS GABA
  RANGE gbar, tau_r, scale, spkcnt, countflag, i, t1, Erev, qfact
  GLOBAL tau_d_GABA
...
PARAMETER {
	...
	tau_d_GABA = 35  	(ms)   	: Galaretta 1997, Table 1
	Erev  = -75   (mV)   	: reversal potential, Czubayko 2002, Tepper 2004
